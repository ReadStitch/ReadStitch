...
class TiaManhwaScraper(BaseScraper):
    def __init__(self):
        super().__init__()
        self.name = "Tia Manhwa"
        self.base_url = "https://tiamanhwa.com"
        # Adicionar cookie de verificação de idade no cabeçalho
        self.headers['Cookie'] = 'tia_idade_confirmada=1'
