...
class EmpreguetesScraper(BaseScraper):
    """Scraper para o site Empreguetes (requer login)."""
    ...
    def __init__(self):
        super().__init__()
        self.base_url = "https://empreguetes.wtf"
    ...
    def login(self, email, password):
        """Autentica na API da Empreguetes e salva o token."""
    ...
    def _fetch_api(self, url):
        if not self.has_active_login():
            raise Exception("A Empreguetes requer login obrigatÃ³rio. FaÃ§a login no aplicativo primeiro.")
    ...
    def get_chapters(self, series_url):
        ...
        if not self.has_active_login():
            try:
                ...
                email = settings.load("empreguetes_email")
                password = settings.load("empreguetes_password")
        ...
        # Ex: https://empreguetes.wtf/obra/10946/alguma-coisa
